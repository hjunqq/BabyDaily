    ...
    <div>
      ...
      <div className="bd-grid two" style={{ marginTop: 16 }}>
        ...
        <div className="bd-card">
          <div style={{ fontWeight: 600, marginBottom: 8 }}>宝宝信息</div>
          <div>姓名：{baby?.name || '--'}</div>
          <div>生日：{baby?.birthday ? new Date(baby.birthday).toLocaleDateString('zh-CN') : '--'}</div>
