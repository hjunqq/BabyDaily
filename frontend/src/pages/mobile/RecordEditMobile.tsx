...
export const RecordEditMobile = () => {
  ...
  return (
    <div>
      <h2 className="bd-title" style={{ fontSize: 22 }}>编辑记录</h2>
      ...
      <div className="bd-fab">
        <Button text={saving ? '保存中...' : '保存修改'} type="default" stylingMode="contained" height={44} onClick={handleSubmit} disabled={saving} />
      </div>
    </div>
  );
};
